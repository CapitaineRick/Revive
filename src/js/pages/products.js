...
function displayProducts(products) {
    ...
    productsGrid.innerHTML = products.map(product => `
        <div class="produit_moreoption" style="display: flex; margin-bottom: 20px; border: 1px solid #ddd; border-radius: 8px; padding: 15px;">
            <img src="https://images.pexels.com/photos/356056/pexels-photo-356056.jpeg?auto=compress&cs=tinysrgb&w=300" alt="${product.nom}" style="width: 20%; border-radius: 5px;">
